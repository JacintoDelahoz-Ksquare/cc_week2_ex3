...
const spinal = (str) => {
    ...
    let separatewhenthereistwocappitalsnexttoeachother = separatewhenthereisnospace.replace(/([A-Z])([A-Z])/g, "$1 $2");
    let spaceforadash = separatewhenthereistwocappitalsnexttoeachother.replace(/\s|_/g, "-");
